    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoty', models.CharField(choices=[('Mobile Phone', 'Mobile Phone'), ('Earphone', 'Earphone'), ('Laptop', 'Laptop'), ('Tablet', 'Tablet'), ('Smart Watch', 'Smart Watch'), ('BT Speaker', 'BT Speaker')], default='Mobile Phone', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
